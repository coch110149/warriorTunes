    ...
    public class AppApiService : JobService
    {
        ...
        public override void OnCreate()
        {
            try
            {
                ...
                new Handler(Looper.MainLooper).PostDelayed(new ChatUpdaterHelper(new Handler(Looper.MainLooper)), AppSettings.RefreshAppAPiSeconds);
            }
            catch (Exception e)
            {
    ...
    public class ChatUpdaterHelper : Java.Lang.Object, IRunnable
    {
        ...
        public void Run()
        {
            try
            {
                ...
                MainHandler?.PostDelayed(new ChatUpdaterHelper(new Handler(Looper.MainLooper)), AppSettings.RefreshAppAPiSeconds);
            }
            catch (Exception e)
            {

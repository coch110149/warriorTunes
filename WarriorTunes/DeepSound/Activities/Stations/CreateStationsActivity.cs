    ...
    public class CreateStationsActivity : BaseActivity 
    {
        ...
        private void InitComponent()
        {
            try
            {
                ...
                FilterButton.Visibility = ViewStates.Gone; //wael  add filter 
        ...
        private void InitToolbar()
        {
            try
            {
                ...
                editText?.SetTextColor(DeepSoundTools.IsTabDark() ? Color.White : Color.Black);
        ...
        private void MAdapterItemClick(object sender, AddStationsAdapterClickEventArgs e)
        {
            try
            {

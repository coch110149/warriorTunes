...
namespace DeepSound.Activities.Stations.Adapters
{
    ...
    {
        public event EventHandler<AddStationsAdapterClickEventArgs> ItemClick;
        public event EventHandler<AddStationsAdapterClickEventArgs> ItemLongClick;
        ...
        void Click(AddStationsAdapterClickEventArgs args) => ItemClick?.Invoke(this, args);
        void LongClick(AddStationsAdapterClickEventArgs args) => ItemLongClick?.Invoke(this, args);

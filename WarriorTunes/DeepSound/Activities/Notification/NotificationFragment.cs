    ...
    public class NotificationFragment : Fragment
    {
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                SettingsButton.SetTextColor(DeepSoundTools.IsTabDark() ? Color.White : Color.Black);
        ...
        //Open user profile
        private void MAdapterItemClick(object sender, NotificationsAdapterClickEventArgs e)
        {
            try
            {
                if (e.Position > -1)

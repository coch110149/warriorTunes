...
namespace DeepSound.Activities.Product.Adapters
{
    ...
    {
        public event EventHandler<ProductReviewsAdapterClickEventArgs> ItemClick;
        public event EventHandler<ProductReviewsAdapterClickEventArgs> ItemLongClick;
        ...
        void Click(ProductReviewsAdapterClickEventArgs args) => ItemClick?.Invoke(this, args);
        void LongClick(ProductReviewsAdapterClickEventArgs args) => ItemLongClick?.Invoke(this, args);
